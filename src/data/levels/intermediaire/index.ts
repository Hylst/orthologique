 ...
 * Mixed categories: orthographe, conjugaison, ponctuation, syntaxe
 */
...
import propositionsTypesPhrase22 from './syntaxe/propositions-types-phrases-22.json';
...
export const intermediaireLessons: Lesson[] = [
  ...
  { ...propositionsTypesPhrase22, unlocked: false, completed: false } as Lesson
];
